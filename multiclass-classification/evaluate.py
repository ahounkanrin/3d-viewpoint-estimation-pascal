...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-pascal/classification_multiclass_{}/{}_samples/checkpoints/".format(args.sigma, args.samples)
...
print("Error = ", errors)
with open("result_{}_real.txt".format(args.category), "w") as f:
...
for theta in thresholds:
    ...
    with open("result_{}_reg.txt".format(args.category), "a") as f:
