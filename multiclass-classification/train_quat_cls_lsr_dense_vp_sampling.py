...
pid.cpu_affinity([0, 1, 2, 3, 4, 5, 6, 7, 8])
...
train_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-pascal/classification_multiclass/{}_samples/logs/train".format(args.samples)
val_logdir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-pascal/classification_multiclass/{}_samples/logs/val".format(args.samples)
