...
checkpoint_dir = "/scratch/hnkmah001/phd-projects/viewpoint-estimation-pascal/classification_multiclass_finetuning/{}_samples/checkpoints/".format(args.samples)
